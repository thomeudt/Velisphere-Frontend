...
public class PreLoadNeu {
	 ...
	 public static void main(String[] args) throws Exception {
	        ...
	        preLoader.callProcedure("SPHERE.insert", "1000", "Home T�bingen", "0");
	      ...
	      /**  
	        ...
	        **/
	        ...
	        while (i<3){
	        	...
	        	preLoader.callProcedure("CHECKPATH.insert", "CP1"+i, "Dummy "+i, "", ""); // Checkpath Button 1,2,3,4 gedr�ckt UNUSED
	        ...
	        preLoader.callProcedure("CHECKPATH.insert", "CP1", "Dummy 1", "", ""); // Checpath f�r alle Buttons
	        preLoader.callProcedure("CHECKPATH.insert", "CP2", "Dummy 2", "", ""); // Checkpath Messenger
	        preLoader.callProcedure("CHECKPATH.insert", "CP3", "Dummy 3", "", ""); // Checkpath Button 5 gedr�ckt UNUSED
	        preLoader.callProcedure("CHECKPATH.insert", "CP4", "Dummy 4", "", ""); // Checkpath Button 1,2,3,4 gedr�ckt UNUSED
	        preLoader.callProcedure("CHECKPATH.insert", "CP5", "Dummy 5", "", ""); // Checkpath Button 1,2,3,4 gedr�ckt UNUSED
	        preLoader.callProcedure("CHECKPATH.insert", "CP6", "Dummy 5", "", ""); // Checkpath Button 1,2,3,4 gedr�ckt UNUSED
