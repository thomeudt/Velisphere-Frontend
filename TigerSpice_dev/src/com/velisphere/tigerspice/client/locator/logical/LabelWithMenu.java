...
public class LabelWithMenu extends DragBox implements HasContextMenu {
    
    String endpointID;
	ContextMenu customMenu;

    
    public LabelWithMenu(final String endpointID, String endpointName, String epcID) {
        super(endpointName, epcID);
